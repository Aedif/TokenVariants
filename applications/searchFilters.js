...
export default class FilterSettings extends FormApplication {
    ...
    async getData(options) {
        ...
        return mergeObject(data, game.settings.get("token-variants", "searchFilterSettings"));
    }
    ...
    activateListeners(html) {
        ...
        addInputValidation(html, "portraitFilterRegex", "portraitFilterInclude", "portraitFilterExclude");
    ...
    async _updateObject(event, formData) {
        ...
        let updatedSettings = mergeObject(game.settings.get("token-variants", "searchFilterSettings"), formData, { insertKeys: false });
